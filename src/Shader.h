//
// This is a simple shaders wrapper class
//
// Created by Hao He on 2018/1/23.
//
...
public:
    ...
    Shader(const GLchar *vertexPath, const GLchar* fragmentPath, const GLchar *geometryPath = nullptr)
    {
        ...
        try {
            ...
            std::cout << "ERROR: Failed to read shaders file at " << vertexPath
                      << " and " << fragmentPath;
            if (geometryPath) {
                std::cout << " " << geometryPath;
            }
            std::cout << std::endl;
            std::cout << "You may want to adjust the shaders file path in the source code. " << std::endl;
        }
        ...
        if (!success) {
            ...
            std::cout << "Failed to compile vertex shaders " << vertexPath << std::endl
        ...
        if (!success) {
            ...
            std::cout << "Failed to compile fragment shaders " << fragmentPath << std::endl
                      << "Info: " << infoLog << std::endl;
        }
        ...
        if (geometryPath) {
            ...
            if (!success) {
                ...
                std::cout << "Failed to compile geometry shaders!" << std::endl
                          << "Info: " << infoLog << std::endl;
            }
        }
        ...
        if (!success) {
            ...
            std::cout << "Failed to link shaders program!" << std::endl
                      << "Info: " << infoLog << std::endl;
        }
